...
object TestCases {
   ...
   fun main(args: Array<String>) {
      ...
      val result2 = testCases.authenticateUser("xeopsssssssssssssssssssssantaaa", 19, "12345678")
      println("TC2: ${
          if (result2 == -1) "Passed = -1" else "Failed"
      }")

      val result3 = testCases.authenticateUser("xeops", 5, "12345678")
      println("TC3: ${
          if (result3 == -2) "Passed = -2" else "Failed"
      }")

      val result4 = testCases.authenticateUser("xeops", 19, "12345678123456781234567812345678")
      println("TC4: ${
