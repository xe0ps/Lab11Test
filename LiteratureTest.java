...
public class LiteratureTest {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("TC3: object " + badLiteratureTwo + "  should not pass check.  Expected result = -2, actual result = " + actualResultThird + " || " + ((-2 == actualResultThird)?("PASSED"):("FAILED")));
